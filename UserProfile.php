    ...
    <div class="contact-us">
        <div class="contact-wrap">
            <div class="contact-in">
                ...
                <a href="adminbookings.php" class="button">BOOKINGS</a>
                <a href="adminpage.php" class="button">CONTACT US</a>
            ...
            <div class="contact-in">
                <h1>OTHERS</h1>
                <a href="adminbookings.php" class="button">ADD NEW ADMIN</a>
                <a href="adminpage.php" class="button">LOGOUT</a>
