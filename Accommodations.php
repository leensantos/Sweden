...
<section class = "rooms sec-width" id = "rooms">
           ...
           <div class = "rooms-container"> 
             <article class = "room">
                 <div class = "room-image">
                     <img src = "assets/image/s1.jpg" alt = "room image">
                 </div>
                 <div class = "room-text">
                     <h3>Suite Room</h3>
                     <ul>
             ...
             <article class = "room">
                 <div class = "room-image">
                     <img src = "assets/image/s2.jpg" alt = "room image">
                 </div>
                 <div class = "room-text">
                     <h3>Suite Room</h3>
                     <ul>
             ...
             <article class = "room">
                 <div class = "room-image">
                     <img src = "assets/image/1.jpg" alt = "room image">
                 </div>
                 <div class = "room-text">
                     <h3>Luxury Rooms</h3>
                     <ul>
       ...
       <article class = "room">
                 <div class = "room-image">
                     <img src = "assets/image/2.jpg" alt = "room image">
                 </div>
                 <div class = "room-text">
                     <h3>Luxury Rooms</h3>
                     <ul>
       ...
       <article class = "room">
                 <div class = "room-image">
                     <img src = "assets/image/3.jpg" alt = "room image">
                 </div>
                 <div class = "room-text">
                     <h3>Luxury Rooms</h3>
                     <ul>
       ...
       <article class = "room">
                 <div class = "room-image">
                     <img src = "assets/image/4.jpg" alt = "room image">
                 </div>
                 <div class = "room-text">
                     <h3>Luxury Rooms</h3>
                     <ul>
       ...
       <article class = "room">
                 <div class = "room-image">
                     <img src = "assets/image/5.jpg" alt = "room image">
                 </div>
                 <div class = "room-text">
                     <h3>Luxury Rooms</h3>
                     <ul>
       ...
       <article class = "room">
                 <div class = "room-image">
                     <img src = "assets/image/6.jpg" alt = "room image">
                 </div>
                 <div class = "room-text">
                     <h3>Luxury Rooms</h3>
                     <ul>
